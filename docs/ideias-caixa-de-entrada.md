...
Lugar para despejar ideia crua, a qualquer hora, sem decidir onde ela vai. **Não classifique aqui** — só escreva. A classificação acontece no começo da próxima sessão de `/wayfinder`, que esvazia esta caixa distribuindo cada item para o lugar certo no [mapa](https://github.com/FerndsTech/alves-assessoria/issues/1).
...
Ideia fora de escopo não se perde — fica registrada no mapa com uma linha. Ela só volta se o destino for redesenhado, e aí como esforço novo, não como continuação.

---

## Não classificadas

<!-- despeje aqui; some daqui quando entrar no mapa -->
